        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="departmentForm" class="form-material form-horizontal" action="{{ route('front-ends.updateHome', $frontEnd) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <fieldset class="custom-fieldset-padding-border-radius">
                        ...
                        <div class="row">
                            <div class="col-md-12 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Video Embed URL')</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" name="videoEmbedUrl" value="{{ $contents->videoEmbedUrl ?? '' }}">
                                        @error('videoEmbedUrl')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                    ...
                    <br>
                    <fieldset class="custom-fieldset-padding-border-radius">
                        <legend class="custom-legend-width-auto"><i class="fas fa-images"></i> @lang('Homepage Images')</legend>
                        <div class="row">
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Consultation Image')</label>
                                    <div class="col-md-12">
                                        <input type="hidden" name="consultationImage" value="{{ $contents->consultationImage ?? '' }}">
                                        <img id="frontend-img-placeholder-height" src="{{ asset($contents->consultationImage ?? 'assets/images/ab.jpg') }}" alt="" class="img-fluid">
                                        <input type="file" class="custom-padding-three" name="consultation_image_file">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Specification Image')</label>
                                    <div class="col-md-12">
                                        <input type="hidden" name="specificationImage" value="{{ $contents->specificationImage ?? '' }}">
                                        <img id="frontend-img-placeholder-height" src="{{ asset($contents->specificationImage ?? 'assets/images/ab1.jpg') }}" alt="" class="img-fluid">
                                        <input type="file" class="custom-padding-three" name="specification_image_file">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('Health Services Image')</label>
                                    <div class="col-md-12">
                                        <input type="hidden" name="healthServicesImage" value="{{ $contents->healthServicesImage ?? '' }}">
                                        <img id="frontend-img-placeholder-height" src="{{ asset($contents->healthServicesImage ?? 'assets/images/g1.jpg') }}" alt="" class="img-fluid">
                                        <input type="file" class="custom-padding-three" name="health_services_image_file">
                                    </div>
                                </div>
                            </div>
                        </div>
