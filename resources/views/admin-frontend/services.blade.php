            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="departmentForm" class="form-material form-horizontal" action="{{ route('front-ends.updateServices', $frontEnd) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <br>
                        <fieldset class="custom-fieldset-padding-border-radius">
                            <legend class="custom-legend-width-auto"><i class="fas fa-image"></i> @lang('Banner Image')</legend>
                            <div class="row">
                                <div class="col-md-12 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Services Banner Image')</label>
                                        <div class="col-md-12">
                                            <input type="hidden" name="servicesBannerImage" value="{{ $contents->servicesBannerImage ?? '' }}">
                                            <img id="frontend-services-max" src="{{ asset($contents->servicesBannerImage ?? 'assets/images/placeholder.jpg') }}" alt="" class="img-fluid">
                                            <input type="file" class="form-control custom-padding-three" name="services_banner_image_file">
                                        </div>
                                    </div>
                                </div>
                            </div>
