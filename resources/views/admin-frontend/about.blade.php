        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="departmentForm" class="form-material form-horizontal" action="{{ route('front-ends.updateAbout', $frontEnd) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <br>
                    <fieldset class="custom-fieldset-padding-border-radius">
                        <legend class="custom-legend-width-auto"><i class="fas fa-image"></i> @lang('Main Image')</legend>
                        <div class="row">
                            <div class="col-md-12 description_padding_left">
                                <div class="form-group">
                                    <label class="col-md-12 col-form-label">@lang('About Main Image')</label>
                                    <div class="col-md-12">
                                        <input type="hidden" name="aboutMainImage" value="{{ $contents->aboutMainImage ?? '' }}">
                                        <img id="frontend-img-placeholder" src="{{ asset($contents->aboutMainImage ?? 'assets/images/ab2.jpg') }}" alt="" class="img-fluid">
                                        <input type="file" class="custom-padding-three" name="about_main_image_file">
                                    </div>
                                </div>
                            </div>
                        </div>
