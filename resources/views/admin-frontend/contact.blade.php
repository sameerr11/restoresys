            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="departmentForm" class="form-material form-horizontal" action="{{ route('front-ends.updateContact', $frontEnd) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <br>
                        <fieldset class="custom-fieldset-padding-border-radius">
                            <legend class="custom-legend-width-auto"><i class="fas fa-image"></i> @lang('Hero Image')</legend>
                            <div class="row">
                                <div class="col-md-12 description_padding_left">
                                    <div class="form-group">
                                        <label class="col-md-12 col-form-label">@lang('Contact Hero Image')</label>
                                        <div class="col-md-12">
                                            <input type="hidden" name="contactHeroImage" value="{{ $contents->contactHeroImage ?? '' }}">
                                            <img id="frontend-img-placeholder-height" src="{{ asset($contents->contactHeroImage ?? 'assets/images/placeholder.jpg') }}" alt="" class="img-fluid">
                                            <input type="file" class="custom-padding-three" name="contact_hero_image_file">
                                        </div>
                                    </div>
                                </div>
                            </div>
