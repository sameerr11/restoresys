    ...
    <nav class="navbar navbar-expand-lg navbar-light px-lg-0 py-0 px-3 stroke">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="{{ url('/') }}">
                <img src="assets/images/logo.png" alt="Logo" style="height: 40px; display: inline-block; vertical-align: middle;">
                <span style="color: #8CC63E; font-weight: bold; font-size: 35px;" class="ml-2 mt-2" style="display: inline-block; vertical-align: middle;">Restore</span>
            </a>
