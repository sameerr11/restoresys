			...
			<div class="history-info position-relative">
				...
				<div class="position-relative">
					...
					<div id="small-dialog" class="zoom-anim-dialog mfp-hide">
						<iframe src="{{ $contents->videoEmbedUrl ?? 'https://www.youtube-nocookie.com/embed/I5fxqp7zh1c?controls=0' }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="consultation-grids">
				...
				<div class="consultation-img">
					<img src="{{ asset($contents->consultationImage ?? 'assets/images/ab.jpg') }}" class="img-fluid" alt="/">
				</div>
			</div>
		</div>
	</section>
			...
			<div class="container py-lg-5">
				<div class="row story-6-grids text-left">
					<div class="col-lg-5 story-gd">
						<img src="{{ asset($contents->specificationImage ?? 'assets/images/ab1.jpg') }}" class="img-fluid" alt="/">
					</div>
