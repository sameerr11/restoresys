...
<body>
	...
	<!-- //breadcrumbs -->
	<!-- services block 2 -->
				<div class="w3l-services-block py-5" id="classes custom-services-background" style="background-image: url('{{ asset($contents->servicesBannerImage ?? 'assets/images/placeholder.jpg') }}'); background-size: cover; background-position: center;">
