...
<body>
	...
	<section class="w3l-contact-main">
		<div class="contant11-top-bg py-5" style="background-image: url('{{ asset($contents->contactHeroImage ?? 'assets/images/placeholder.jpg') }}'); background-size: cover; background-position: center;">
